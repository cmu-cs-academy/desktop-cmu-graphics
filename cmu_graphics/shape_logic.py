...
class RGB(object):
    def __init__(self, red, green, blue):
        self.__dict__['attrs'] = {'class': self.__class__.__name__}
        self._red = red
        self._green = green
        self._blue = blue
