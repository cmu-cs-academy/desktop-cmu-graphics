...
TRANSLATED_COLOR_NAMES = {
    ...
    'es': {
        ...
        'bisque': 'bisque',
        'black': 'negro',
        'blanchedalmond': 'almendrablanqueada',
        'blue': 'azul',
        'blueviolet': 'azulvioleta',
        'brown': 'marrón',
        'burlywood': 'madera',
        'cadetblue': 'azulcadete',
        'chartreuse': 'verdeamarillento',
        'chocolate': 'chocolate',
        'coral': 'coral',
        'cornsilk': 'maizseda',
        'cornflowerblue': 'azualaciano',
        'crimson': 'carmesí',
        'cyan': 'cian',
        'darkblue': 'azuloscuro',
        'darkcyan': 'cianoscuro',
        'darkgoldenrod': 'varilladoradaoscura',
        'darkgray': 'grisoscuro',
        'darkgreen': 'verdeoscuro',
        'darkgrey': 'grisoscuro',
        'darkkhaki': 'caquioscuro',
        'darkmagenta': 'magentaoscuro',
        'darkolivegreen': 'verdeolivaoscuro',
        'darkorange': 'naranjaoscuro',
        'darkorchid': 'orquídeaoscura',
        'darkred': 'rojooscuro',
        'darksalmon': 'salmónoscuro',
        'darkseagreen': 'marverdeoscuro',
        'darkslateblue': 'azulpizarraoscuro',
        'darkslategray': 'grispizarraoscuro',
        'darkslategrey': 'grispizarraoscuro',
        'darkturquoise': 'turquesaoscuro',
        'darkviolet': 'violetaoscuro',
        'deeppink': 'rosadoprofundo',
        'deepskyblue': 'azulcieloprofundo',
        'dimgray': 'gristurbio',
        'dimgrey': 'gristurbio',
        'dodgerblue': 'azulgandul',
        'firebrick': 'ladrillo',
        'floralwhite': 'blancofloral',
        'forestgreen': 'verdebosque',
        'fuchsia': 'fucsia',
        'gainsboro': 'gainsboro',
        'ghostwhite': 'blancofantasma',
        'gold': 'oro',
        'goldenrod': 'varilladorada',
        'gray': 'gris',
        'green': 'verde',
        'greenyellow': 'verdeamarillo',
        'grey': 'gris',
        'honeydew': 'melón',
        'hotpink': 'rosadofuerte',
        'indianred': 'rojoindio',
        'indigo': 'índigo',
        'ivory': 'marfil',
        'khaki': 'caqui',
        'lavender': 'lavanda',
        'lavenderblush': 'ruborlavanda',
        'lawngreen': 'cespedverde',
        'lemonchiffon': 'limónchifón',
        'lightblue': 'azulclaro',
        'lightcoral': 'coralclaro',
        'lightcyan': 'cianclaro',
        'lightgoldenrodyellow': 'varilladoradaclaraamarilla',
        'lightgray': 'grisclaro',
        'lightgreen': 'verdeclaro',
        'lightgrey': 'grisclaro',
        'lightpink': 'rosadoclaro',
        'lightsalmon': 'salmónclaro',
        'lightseagreen': 'marverdeclaro',
        'lightskyblue': 'azulcieloclaro',
        'lightslategray': 'grispizarraclaro',
        'lightslategrey': 'grispizarraclaro',
        'lightsteelblue': 'azulaceroclaro',
        'lightyellow': 'amarilloclaro',
        'lime': 'lima',
        'limegreen': 'limaverde',
        'linen': 'lino',
        'magenta': 'magenta',
        'maroon': 'granate',
        'mediumaquamarine': 'aguamarinamedio',
        'mediumblue': 'azulmedio',
        'mediumorchid': 'orquídeamedio',
        'mediumpurple': 'púrpuramedio',
        'mediumseagreen': 'marverdemedio',
        'mediumslateblue': 'pizarraazulmedio',
        'mediumspringgreen': 'verdeprimaveramedio',
        'mediumturquoise': 'turquesamedio',
        'mediumvioletred': 'violetarojomedio',
        'midnightblue': 'azulmedianoche',
        'mintcream': 'cremamenta',
        'mistyrose': 'nebulosarosa',
        'moccasin': 'mocasín',
        'navajowhite': 'blanconaranja',
        'navy': 'azulmarino',
        'oldlace': 'cordónviejo',
        'olive': 'oliva',
        'olivedrab': 'verdemilitar',
        'orange': 'naranja',
        'orangered': 'rojonaranja',
        'orchid': 'orquídea',
        'palegoldenrod': 'varilladoradapálida',
        'palegreen': 'verdepálido',
        'paleturquoise': 'turquesapálido',
        'palevioletred': 'rojovioletapálido',
        'papayawhip': 'látigodepapaya',
        'peachpuff': 'durazno',
        'peru': 'naranjamarrón',
        'pink': 'rosado',
        'plum': 'ciruela',
        'powderblue': 'azulpolvo',
        'purple': 'púrpura',
        'red': 'rojo',
        'rosybrown': 'marrónrosado',
        'royalblue': 'azulreal',
        'saddlebrown': 'marróncuero',
        'salmon': 'salmón',
        'sandybrown': 'marrónarenoso',
        'seagreen': 'marverde',
        'seashell': 'caracol',
        'sienna': 'tierra',
        'silver': 'plateado',
        'skyblue': 'azulcielo',
        'slateblue': 'azulpizarra',
        'slategray': 'grispizarra',
        'slategrey': 'grispizarra',
        'snow': 'nieve',
        ...
        'wheat': 'trigo',
        'white': 'blanco',
        'whitesmoke': 'humoblanco',
        'yellow': 'amarillo',
        'yellowgreen': 'amarilloverde',
    },
    'de': {
        'aliceblue': 'aliceblau',
        'antiquewhite': 'altweiß',
        'aqua': 'wasser',
        ...
        'khaki': 'khaki',
        'lavender': 'lavendel',
        'lavenderblush': 'lavendelröte',
        'lawngreen': 'rasengrün',
        'lemonchiffon': 'zitronenchiffon',
        'lightblue': 'hellblau',
        'lightcoral': 'hellkoralle',
        'lightcyan': 'hellcyan',
        'lightgoldenrodyellow': 'leichtgoldrutengelb',
        'lightgray': 'hellgrau',
        'lightgreen': 'hellgrün',
        'lightgrey': 'hellgraube',
        'lightpink': 'hellrosa',
        'lightsalmon': 'helllachs',
        'lightseagreen': 'hellseegrün',
        'lightskyblue': 'hellhimmelblau',
        'lightslategray': 'hellschiefergrau',
        'lightslategrey': 'hellschiefergraube',
        'lightsteelblue': 'hellstahlblau',
        ...
        'magenta': 'magenta',
        'maroon': 'kastanie',
        'mediumaquamarine': 'mittelaquamarine',
        'mediumblue': 'mittelblau',
        'mediumorchid': 'mittelorchidee',
        'mediumpurple': 'mittelviolett',
        'mediumseagreen': 'mittelseegrün',
        ...
        'orangered': 'orangerot',
        'orchid': 'orchidee',
        'palegoldenrod': 'blassegoldrute',
        'palegreen': 'blassgrün',
        'paleturquoise': 'blasstürkis',
        'palevioletred': 'blasslilarot',
        'papayawhip': 'papayafarben',
        'peachpuff': 'pfirsich',
        'peru': 'peru',
        'pink': 'rosa',
        'plum': 'pflaume',
...
TRANSLATED_SHAPE_ATTRS = {
    ...
    'es': {
        ...
        'centerX': 'centroX',
        'hits': 'toca',
        'borderWidth': 'anchuraDeBorde',
        'centerY': 'centroY',
        'url': 'url',
        'left': 'izquierda',
        'add': 'agregar',
        'points': 'puntos',
        'startAngle': 'ánguloInicial',
        'toBack': 'alFondo',
        'x2': 'x2',
        'y1': 'y1',
        'size': 'tamaño',
        'initialPoints': 'puntosIniciales',
        'top': 'superior',
        'align': 'alinear',
        'dashes': 'guión',
        'right': 'derecha',
        ...
        'radius': 'radio',
        'border': 'borde',
        'containsShape': 'contieneFigura',
        'background': 'fondo',
        'height': 'altura',
        'lineWidth': 'anchuraDeLínea',
        'toFront': 'alFrente',
        'roundness': 'redondez',
        'arrowEnd': 'finalDeFlecha',
        'x1': 'x1',
        'fill': 'relleno',
        'bottom': 'inferior',
        'clear': 'vaciar',
        'sweepAngle': 'ánguloDeBarrido',
        'value': 'valor',
        'contains': 'contiene',
        'italic': 'itálica',
        'visible': 'visible',
        'arrowStart': 'inicioDeFlecha',
        'hitsShape': 'tocaFigura',
        'font': 'fuente',
        'children': 'hijos',
        'hitTest': 'tocarPrueba',
        'width': 'ancho',
        'rotateAngle': 'rotarÁngulo',
        'red': 'red',
        'blue': 'blue',
        'green': 'green',
    },
    'de': {
        ...
        'add': 'fügeHinzu',
        'points': 'punkte',
        'startAngle': 'anfangsWinkel',
        'toBack': 'nachHinten',
        'x2': 'x2',
        'y1': 'y1',
        'size': 'größe',
        'initialPoints': 'startPunkte',
        'top': 'oben',
        'align': 'ausrichtung',
        'dashes': 'gestrichelt',
        'right': 'rechts',
        ...
        'bottom': 'unten',
        'clear': 'leeren',
        'sweepAngle': 'krümmungsWinkel',
        'value': 'wert',
        'contains': 'beinhaltet',
        'italic': 'kursiv',
        'visible': 'sichtbar',
        'arrowStart': 'pfeilStart',
        'hitsShape': 'trifftForm',
        'font': 'schriftart',
        'children': 'kinder',
        'hitTest': 'treffenTest',
        'width': 'breite',
...
TRANSLATED_GLOBALS = {
    ...
    'es': {
        ...
        'Polygon': 'Polígono',
        'Rect': 'Rect',
        'RegularPolygon': 'PolígonoRegular',
        'Robot': 'Robot',
        'Sound': 'Sonido',
        'Star': 'Estrella',
        'almostEqual': 'casiIgualA',
        'angleTo': 'ánguloA',
        'app': 'app',
        'assertEqual': 'afirmarIgualdad',
        'choice': 'opción',
        'distance': 'distancia',
        'fromPythonAngle': 'deÁnguloPython',
        'getPointInDir': 'obtenerPuntoEnDir',
        'gradient': 'gradiente',
        'makeList': 'hacerLista',
        'onKeyHolds': 'enTeclasRetenidas',
        'onSteps': 'enPasos',
        'print': 'imprime',
        'pythonRound': 'redondearPython',
        'random': 'aleatorio',
        'randrange': 'rangoAleatorio',
        'rgb': 'rgb',
        'round': 'redondear',
        'rounded': 'redondeado',
        'seed': 'semilla',
        'toPythonAngle': 'aÁnguloPython',
        'onKeyPresses': 'enTeclaPresionadas',
        'CMUImage': 'CMUImage',
    },
    'de': {
        'Arc': 'Bogen',
        ...
        'Polygon': 'Vieleck',
        'Rect': 'Rechteck',
        'RegularPolygon': 'RegelmäßigesVieleck',
        'Robot': 'Roboter',
        'Sound': 'Geräusch',
        'Star': 'Stern',
        'almostEqual': 'fastGleich',
        'angleTo': 'winkelNach',
        'app': 'anwendung',
        'assertEqual': 'gleichsetzen',
        'choice': 'auswahl',
        'distance': 'distanz',
        'fromPythonAngle': 'vomPythonWinkel',
        'getPointInDir': 'erhaltePunktInRichtung',
        'gradient': 'farbverlauf',
        'makeList': 'macheListe',
        'onKeyHolds': 'wennTasteGedrückt',
        'onSteps': 'schrittweise',
        'print': 'ausgabe',
        'pythonRound': 'pythonRunden',
        'random': 'zufall',
        'randrange': 'zufallsspanne',
        'rgb': 'RGB',
        'round': 'runden',
        'rounded': 'gerundet',
        'seed': 'kerne',
        'toPythonAngle': 'zumPythonWinkel',
        'onKeyPresses': 'wennTasteGedrückt',
        'CMUImage': 'CMUImage',
    },
}
TRANSLATED_USER_FUNCTION_NAMES = {
    ...
    'es': {
        'onKeyHold': 'enTeclaRetenida',
        'onKeyPress': 'enTeclaPresionada',
        'onKeyRelease': 'enTeclaSoltada',
        'onMouseDrag': 'enRatónArrastrado',
        'onMouseMove': 'enRatónMovido',
        'onMousePress': 'enRatónPresionado',
        'onMouseRelease': 'enRatónSoltado',
        'onStep': 'enPaso',
    },
    'de': {
        'onKeyHold': 'beiTasteHalten',
        'onKeyPress': 'beiTasteRunter',
        'onKeyRelease': 'beiTasteHoch',
        'onMouseDrag': 'beiMausMitTasteZiehen',
        'onMouseMove': 'beiMausbewegung',
        'onMousePress': 'beiMaustasteRunter',
        'onMouseRelease': 'beiMaustasteHoch',
        'onStep': 'beimSchritt',
    },
}
...
TRANSLATED_APP_ATTRS = {
    ...
    'es': {
        'background': 'fondo',
        'getTextInput': 'obtenerEntradaDeTexto',
        'group': 'grupo',
        'maxShapeCount': 'maxCuentaDeFiguras',
        'paused': 'pausada',
        'setTextInputs': 'establecerEntradaDeTexto',
        'stepsPerSecond': 'pasosPorSegundo',
        'stop': 'detener',
        'stopped': 'detenido',
        'setMaxShapeCount': 'establecerCuentaFormasMaximas',
    },
    'de': {
        'background': 'hintergrund',
        'getTextInput': 'holeTextEingabe',
        'group': 'gruppe',
        'maxShapeCount': 'maximaleFormMenge',
        'paused': 'pausiert',
        'setTextInputs': 'setzeTextEingaben',
        'stepsPerSecond': 'schritteProSekunde',
        'stop': 'stop',
        'stopped': 'gestoppt',
        'setMaxShapeCount': 'setzeMaxFormAnzahl',
    },
}
TRANSLATED_STRINGS = {
    'keys': [
        ...
        '"{{attr}}" is not a valid shape constructor argument',
        '**** Error in onError()!!! ****',
        'An assertEqual() statement in a test case failed. See the Console for details.',
        'An error occurred. Here is the stack trace:',
        'App',
        'App.group is readonly',
        ...
        'Autograder: error executing solution code!',
        'Autograder: error executing user code!',
        'Autograding is taking a long time. Your code may have an infinite loop.',
        'Both rows and cols must be >= 0',
        "Cannot set Image's url",
        "Cannot set Label's height",
        "Cannot set Label's width",
        "Cannot set Line's border",
        "Cannot set Line's borderWidth",
        'Circle',
        'Circle{{attrs}}',
        'Failed to get text input',
        'Failed to load image data',
        'Font not found: {{baseFontName}}\n',
        'Group',
        'Group()',
        'Group.add(shape)',
        'Group.remove(shape)',
        'Group.{{attr}} cannot be read or modified',
        "Group.{{attr}} has no value because its children don't all have the same value for {{attr}}",
        '{{error}}: Illegal gradient start ({{start}})',
        'Image',
        'Image{{args}}',
        'Internal error (no solution shapes!).  Please try again.',
        'Label',
        'Label({{args}})',
        'Line',
        'Line{{args}}',
        'Must have an even number of x,y values in initialPoints list',
        'Need to pass at least 2 colors to gradient(); you gave {{colorsLength}}',
        'No activeDrawing for new Shape',
        ...
        'Shape',
        'Shape()',
        'Shapes drawn in wrong order',
        "Sorry, you cannot use Python's input function in CMU CS Academy",
        'Sound',
        'Sound "{{soundSource}}" failed to play. Disabling it.',
        'Star',
        'Star{{args}}',
        'The loop argument to Sound.play must be True or False, got {{loopRepr}}',
        'The restart argument to Sound.play must be True or False, got {{restartRepr}}',
        ...
        '{{error}}: None cannot be used inside gradient.colors',
        '{{error}}: {{callSpec}} should be {{typeName}} (but {{value}} is of type {{valueType}})',
        '{{error}}: {{color}} cannot be used inside gradient.colors',
        '{{error}}: {{callSpec}} should be a color, and {{value}} is not a legal color name',
        'Undefined poster in new _CmuGraphics',
        'Unknown message {{cmd}}',
        ...
        'Wait for fonts to load before using them',
        'Wrong # of points ({{userPtsLen}} should be {{solnPtsLen}})',
        'You are missing {{missingCount}} shape(s)',
        "You can't change the size of this group because {{shape}} can't be resized",
        "You can't get or set the align property",
        'You have {{extraCount}} extra shape(s)',
        'Your code appeared to be in an infinite loop, so it was terminated.',
        ...
        'add{{xy}}',
        'align',
        'app.background should not be {{userBackgroundString}}',
        ...
        'height',
        'hits(x, y)',
        'hitsShape(targetShape)',
        'initialPoints',
        'initialPoints (x value)',
        'initialPoints (y value)',
        'integer',
        'italic',
        'keys must be a list',
        'left',
        ...
        '{{actual}} != {{expected}}',
        '{{attr}} in {{object}}',
        '{{attr}} should not be {{value}}',
        '{{ordinalName}} point mismatch at {{location}}',
        'play',
        'pause',
        'restart',
        'loop',
        'TypeError',
        '{{error}}: in {{callSpec}}, {{value}} is not a legal align value',
        ...
        'green',
        'blue',
        '{{callSpec}} must start with http:// or https://',
    ],
    'es': {
        'Arc': 'Arco',
        'Circle': 'Círculo',
        ...
        'width': 'ancho',
        'rotateAngle': 'rotarÁngulo',
        '"{{align}}" is not a valid Polygon constructor argument': '"alinear" no es un argumento de constructor de Polígono válido',
        '"{{attr}}" is not a valid shape constructor argument': '"{{attr}}" no es un argumento de constructor de formas válido',
        '**** Error in onError()!!! ****': '**** ¡¡¡Error dentro de enError()!!! ****',
        'An assertEqual() statement in a test case failed. See the Console for details.': 'Una sentencia assertEqual() dentro de un caso de prueba falló. Mire la consola para detalles.',
        'An error occurred. Here is the stack trace:': 'Ocurrió un error. Aquí está el seguimiento de la pila:',
        'App': 'App',
        'App.group is readonly': 'App.grupo es sólo lectura',
        'App.stopped is readonly': 'App.detenido es sólo lectura',
        'Arg Count Error: {{callSpec}}() takes {{argNamesLen}} arguments ({{argNames}}), not {{argsLen}}': 'Arg Count Error: {{callSpec}}() toma {{argNamesLen}} argumentos ({{argNames}}), no {{argsLen}}',
        'Arguments to setTextInputs must be strings. %r is not a string.': 'Arguments to setTextInputs must be strings. %r is not a string.',
        'Autograder: error executing solution code!': 'Evaluador: ¡error al ejecutar el código de la solución!',
        'Autograder: error executing user code!': 'Evaluador: ¡error al ejecutar el código del usuario!',
        'Autograding is taking a long time. Your code may have an infinite loop.': 'El evaluador está tardando mucho. Su código puede tener un bucle infinito.',
        'Both rows and cols must be >= 0': 'Ambos las filas y las cols deben ser >= 0',
        "Cannot set Image's url": 'No se puede establecer el url de una Imagen',
        "Cannot set Label's height": 'No se puede establecer la altura de una Línea',
        "Cannot set Label's width": 'No se puede establecer la anchura de una Línea',
        "Cannot set Line's border": 'No se puede establecer el borde de una Línea',
        "Cannot set Line's borderWidth": 'No se puede establecer la anchura de una Línea',
        'Circle{{attrs}}': 'Círculo{{attrs}}',
        'Failed to get text input': 'No se pudo obtener entrade de texto',
        'Failed to load image data': 'No se puedo cargar los datos de la imagen',
        'Font not found: {{baseFontName}}\n': 'Fuente no encontrada: {{baseFontName}}\\n',
        'Group()': 'Grupo()',
        'Group.add(shape)': 'Grupo.agregar(figura)',
        'Group.remove(shape)': 'Grupo.quitar(figura)',
        'Group.{{attr}} cannot be read or modified': 'Grupo.{{attr}} no se puede leer ni modificar',
        "Group.{{attr}} has no value because its children don't all have the same value for {{attr}}": 'Grupo.{{attr}} no tiene valor porque no todos sus elementos secundarios tienen el mismo valor para {{attr}}',
        '{{error}}: Illegal gradient start ({{start}})': '{{error}}: Inicio de gradiente ilegal ({{start}})',
        'Image{{args}}': 'Imagen{{args}}',
        'Internal error (no solution shapes!).  Please try again.': 'Error internal (¡no figuras en su solución!).  Por favor inténtelo otra vez.',
        'Label({{args}})': 'Rótulo({{args}})',
        'Line{{args}}': 'Línea{{args}}',
        'Must have an even number of x,y values in initialPoints list': 'Debe tener un número par de valores x,y dentro de la lista puntosIniciales',
        'Need to pass at least 2 colors to gradient(); you gave {{colorsLength}}': 'Necesita dar al menos 2 colores a gradiente(); diste {{colorsLength}}',
        'No activeDrawing for new Shape': 'No hay un dibujoActivo para la Figura nueva',
        'No such attribute: {{attr}}': 'No existe tal atributo: {{attr}}',
        'None': 'None',
        'Oval{{args}}': 'Óvalo{{args}}',
        'Polygon{{args}}': 'Polígono{{args}}',
        'Recording Starts In': 'Grabación comenzando en',
        'Rect{{args}}': 'Rect{{args}}',
        'RegularPolygon{{args}}': 'PolígonoRegular{{args}}',
        'Shape': 'Figura',
        'Shape()': 'Figura()',
        'Shapes drawn in wrong order': 'Figuras dibujadas en el orden equivocado',
        "Sorry, you cannot use Python's input function in CMU CS Academy": 'Lo lamento, no puede usar la función de entrada de Python en CMU CS Academy',
        'Sound "{{soundSource}}" failed to play. Disabling it.': 'Sonido "{{soundSource}}" no pudo jugar. Desactivando.',
        'Star{{args}}': 'Estrella{{args}}',
        'The loop argument to Sound.play must be True or False, got {{loopRepr}}': 'El argumento de repetición de Sonido.tocar debe ser Verdadero o Falso, obtuvo {{loopRepr}}',
        'The restart argument to Sound.play must be True or False, got {{restartRepr}}': 'El argumento de reinicio de Sonido.tocar debe ser Verdadero o Falso, obtuvo {{reiniciarRepr}}',
        'Too many shapes: Your code created more than {{maxShapeCount}} shapes. If you would like to increase this limit even though it may cause your code to run slowly, call app.setMaxShapeCount(n).': 'Demasiadas formas: Su código creó más de {{maxShapeCount}} formas. Si desea aumentar este límite, aunque puede hacer que su código se ejecute lentamente, llame a app.establecerCuentaFormasMaximas(n).',
        'Traceback (most recent call last):': 'rastreo (última llamada más reciente):',
        '{{error}}: None cannot be used inside gradient.colors': '{{error}}: None no se puede usar dentro de gradientes.colores',
        '{{error}}: {{callSpec}} should be {{typeName}} (but {{value}} is of type {{valueType}})': '{{error}}: {{callSpec}} debe ser {{typeName}} (pero {{value}} es de tipo {{valueType}})',
        '{{error}}: {{color}} cannot be used inside gradient.colors': '{{error}}: {{color}} no se puede utilizar dentro de gradiente.colores',
        '{{error}}: {{callSpec}} should be a color, and {{value}} is not a legal color name': '{{error}}: {{callSpec}} debe ser un color, y {{value}} no es un nombre de color legal',
        'Undefined poster in new _CmuGraphics': 'Posteador indefinido en nuevo _CmuGraphics',
        'Unknown message {{cmd}}': 'Mensaje desconocido {{cmd}}',
        "Use our rounded(n) instead of Python 3's round(n)\n  Python 3's round(n) does not work as one might expect!\n  If you still want Python 3's round, use pythonRound": 'Use nuestra función redondear(n) en lugar del "round(n)" de Python\\n ¡La función "round(n)" de Python 3 no funciona como uno espera!\\n Si todavía quiere usar el "round" de Python, use "pythonRound"',
        'Wait for fonts to load before using them': 'Espere a que se carguen las fuentes antes de usarlas',
        'Wrong # of points ({{userPtsLen}} should be {{solnPtsLen}})': '# incorrecto de puntos ({{userPtsLen}} debe ser {{solnPtsLen}})',
        'You are missing {{missingCount}} shape(s)': 'Te faltan {{missingCount}} forma(s)',
        "You can't change the size of this group because {{shape}} can't be resized": 'No puedes cambiar el tamaño de este grupo porque no se puede cambiar el tamaño de {{shape}}',
        "You can't get or set the align property": 'No puede obtener o establecer la propiedad de alinear',
        'You have {{extraCount}} extra shape(s)': 'Tienes {{extraCount}} forma(s) adicionales',
        'Your code appeared to be in an infinite loop, so it was terminated.': 'Your code appeared to be in an infinite loop, so it was terminated.',
        ...
        'add{{xy}}': 'añadir{{xy}}',
        'app.background should not be {{userBackgroundString}}': 'app.fondo no debe ser {{userBackgroundString}}',
        'app.setMaxShapeCount(n)': 'app.establecerMáximaCuentaDeFiguras(n)',
        'at line': 'en la línea',
        'black': 'negro',
        'bottom-left': 'inferior-izquierda',
        'bottom-right': 'inferior-derecha',
        'center': 'centro',
        'centroidX': 'centroideX',
        'centroidY': 'centroideY',
        'color': 'color',
        'containsShape(targetShape)': 'contieneFigura(figuraObjetivo)',
        'gradient({{colors}}, start={{start}})': 'gradient({{colors}}, start={{start}})',
        'hits(x, y)': 'toca(x, y)',
        'hitsShape(targetShape)': 'tocaFigura(figuraObjetivo)',
        'initialPoints (x value)': 'puntosIniciales (valor x)',
        'initialPoints (y value)': 'puntosIniciales (valor y)',
        'integer': 'número entero',
        'keys must be a list': 'teclas debe ser una lista',
        'left-bottom': 'izquierda-inferior',
        'left-top': 'izquierda-superior',
        'line': 'línea',
        'list': 'lista',
        'n': 'n',
        'non-negative-number': 'número-no-negativo',
        'number': 'número',
        'number-greater-than-2': 'número-mayor-que-2',
        'number-in-range-{{lo}}-{{hi}}': 'número-en-rango-{{lo}}-{{hi}}',
        'oval size': 'tamaño de óvalo',
        ...
        'rotate.cx': 'rotar.cx',
        'rotate.cy': 'rotar.cy',
        'rotate.degrees': 'rotar.grados',
        'scale{{xy}}': 'escala{{xy}}',
        'shape': 'figura',
        'string': 'cadena',
        'targetShape': 'figuraObjetivo',
        'top-left': 'superior-izquierda',
        'top-right': 'superior-derecha',
        'x': 'x',
        'y': 'y',
        '{{actual}} != {{expected}}': '{{actual}} != {{expected}}',
        '{{attr}} in {{object}}': '{{attr}} dentro de {{object}}',
        '{{attr}} should not be {{value}}': '{{attr}} no debe ser {{value}}',
        '{{ordinalName}} point mismatch at {{location}}': '{{ordinalName}} desajuste de puntos en {{location}}',
        'play': 'toca',
        'pause': 'pausa',
        'restart': 'reiniciar',
        'loop': 'repetir',
        'TypeError': 'Error de tipo',
        '{{error}}: in {{callSpec}}, {{value}} is not a legal align value': '{{error}}: en {{callSpec}}, {{value}} no es un valor legal de alineación',
        "{{error}}: {{callSpec}} got an unexpected keyword argument '{{arg}}'": "{{error}}: {{callSpec}} tiene un argumento de palabra clave inesperado '{{arg}}'",
        'contains(x, y)': 'contiene(x, y)',
        'hitTest(x, y)': 'tocarPrueba(x, y)',
        'addPoint(x, y)': 'agregarPunto(x, y)',
        'red': 'red',
        'green': 'green',
        'blue': 'blue',
        '{{callSpec}} must start with http:// or https://': '{{callSpec}} debe comenzar con http:// o https://',
        "Cannot modify attribute '{{attr}}' of '{{className}}' object": "No se puede modificar el atributo '{{attr}}' del objeto de '{{className}}'",
    },
    'de': {
        'Arc': 'Bogen',
        'Circle': 'Kreis',
        ...
        'width': 'breite',
        'rotateAngle': 'drehWinkel',
        '"{{align}}" is not a valid Polygon constructor argument': '"alinear" ist kein gültiges Argument für den Konstruktor von Polygon',
        '"{{attr}}" is not a valid shape constructor argument': '"{{attr}}" ist kein valides Argument des Konstruktors von Form',
        '**** Error in onError()!!! ****': '**** Fehler in wennFehler()!!! ****',
        'An assertEqual() statement in a test case failed. See the Console for details.': 'Eine assertEqual() Anweisung in einem Testfall ist fehlgeschlagen. Schau auf die Konsole um Details zu sehen.',
        'An error occurred. Here is the stack trace:': 'Ein unbekannter Fehler ist aufgetreten. Hier ist der Stack Tracke:',
        'App': 'Anwendung',
        'App.group is readonly': 'App.gruppe nur lesbar',
        'App.stopped is readonly': 'App.gestoppt ist nur lesbar',
        'Arg Count Error: {{callSpec}}() takes {{argNamesLen}} arguments ({{argNames}}), not {{argsLen}}': 'Fehlerhafte Anzahl der Argumente: {{callSpec}} () akzeptiert {{argNamesLen}} Argumente ({{argNames}}), nicht {{argsLen}}',
        'Arguments to setTextInputs must be strings. %r is not a string.': 'Arguments to setTextInputs must be strings. %r is not a string.',
        'Autograder: error executing solution code!': 'Autograder: Fehler beim Ausführen des Lösungscodes!',
        'Autograder: error executing user code!': 'Autograder: Fehler beim Ausführen des Benutzercodes!',
        'Autograding is taking a long time. Your code may have an infinite loop.': 'Autograding dauert lange. Möglicherweise gibt es eine Endlosschleife in deinem Code.',
        'Both rows and cols must be >= 0': 'Sowohl Zeilen als auch Spalten müssen >= 0 sein',
        "Cannot set Image's url": 'Die URL des Bildes kann nicht festgelegt werden',
        "Cannot set Label's height": 'Die Höhe des Labels kann nicht eingestellt werden',
        "Cannot set Label's width": 'Breite des Labels kann nicht gesetzt werden',
        "Cannot set Line's border": 'Der Linienrand kann nicht festgelegt werden',
        "Cannot set Line's borderWidth": 'Die Rahmenbreite von Line kann nicht festgelegt werden',
        'Circle{{attrs}}': 'Kreis{{attrs}}',
        'Failed to get text input': 'Fehler bei der Texteingabe',
        'Failed to load image data': 'Fehler beim Laden der Bilddaten',
        'Font not found: {{baseFontName}}\n': 'Schriftart nicht gefunden: {{baseFontName}}\\n',
        'Group()': 'Gruppe()',
        'Group.add(shape)': 'Gruppe.fügeHinzu(form)',
        'Group.remove(shape)': 'Gruppe.entferne(form)',
        'Group.{{attr}} cannot be read or modified': 'Gruppe.{{attr}} kann nicht gelesen oder geändert werden',
        "Group.{{attr}} has no value because its children don't all have the same value for {{attr}}": 'Gruppe.{{attr}} hat keinen Wert, da die untergeordneten Elemente nicht alle den gleichen Wert für {{attr}} haben',
        '{{error}}: Illegal gradient start ({{start}})': '{{error}}: Illegaler Start des Farbverlaufs ({{start}})',
        'Image{{args}}': 'Bild{{args}}',
        'Internal error (no solution shapes!).  Please try again.': 'Interner Fehler (keine Lösungsformen!). Bitte versuche es noche einmal.',
        'Label({{args}})': 'Beschriftung({{args}})',
        'Line{{args}}': 'Linie{{args}}',
        'Must have an even number of x,y values in initialPoints list': 'Muss eine gerade Anzahl von x,y Werten in der Liste anfangsPunkte haben',
        'Need to pass at least 2 colors to gradient(); you gave {{colorsLength}}': 'Es müssen mindestens 2 Farben an farbverlauf() übergeben werden. Du hast {{farbenLänge}} gegeben',
        'No activeDrawing for new Shape': 'Keine aktiveZeichnung für neue Form',
        'No such attribute: {{attr}}': 'Kein solches Attribut: {{attr}}',
        'None': 'None',
        'Oval{{args}}': 'Oval{{args}}',
        'Polygon{{args}}': 'Polygon{{args}}',
        'Recording Starts In': 'Aufnahme startet in',
        'Rect{{args}}': 'Rechteck{{args}}',
        'RegularPolygon{{args}}': 'RegularPolygon {{args}}',
        'Shape': 'Form',
        'Shape()': 'Form()',
        'Shapes drawn in wrong order': 'Formen werden in der falschen Reihenfolge gezeichnet',
        "Sorry, you cannot use Python's input function in CMU CS Academy": "Leider kannst du Python's input Funktion nicht in CMU CS Academy nutzen",
        'Sound "{{soundSource}}" failed to play. Disabling it.': 'Klang "{{soundSource}}" konnte nicht abgespielt werden. Wird deaktiviert.',
        'Star{{args}}': 'Stern{{args}}',
        'The loop argument to Sound.play must be True or False, got {{loopRepr}}': 'Das Schleifenargument für Sound.play muss True oder False sein, {{loopRepr}}',
        'The restart argument to Sound.play must be True or False, got {{restartRepr}}': 'Das Argument um Sound.play neuzustarten muss True oder False sein und {{restartRepr}} erhalten haben',
        ...
        'Traceback (most recent call last):': 'Aufrufliste (jüngster Aufruf zuletzt)',
        '{{error}}: None cannot be used inside gradient.colors': '{{error}}: None kann nicht innerhalb von farbverlauf.farben verwendet werden',
        '{{error}}: {{callSpec}} should be {{typeName}} (but {{value}} is of type {{valueType}})': '{{error}}: {{callSpec}} sollte {{typeName}} sein (aber {{value}} ist vom Typ {{valueType}})',
        '{{error}}: {{color}} cannot be used inside gradient.colors': '{{error}}: {{color}} kann nicht in gradient.colors verwendet werden',
        '{{error}}: {{callSpec}} should be a color, and {{value}} is not a legal color name': '{{error}}: {{callSpec}} sollte eine Farbe sein, und {{value}} ist kein zulässiger Farbname',
        'Undefined poster in new _CmuGraphics': 'Nicht definiertes Poster in neuem _CmuGraphics',
        'Unknown message {{cmd}}': 'Unbekannte Nachricht {{cmd}}',
        "Use our rounded(n) instead of Python 3's round(n)\n  Python 3's round(n) does not work as one might expect!\n  If you still want Python 3's round, use pythonRound": "Verwenden Sie unsere Funktion rounded(n) anstelle der Python 3 Funktion round(n)\\n Python 3's round(n) funktioniert nicht wie erwartet!\\n Wenn Sie die Funktion round() von Python 3 weiterhin verwenden möchten, dann nutzen Sie pythonRound",
        'Wait for fonts to load before using them': 'Warte, bis Zeichensatz geladen ist, bevor du ihn verwendest',
        'Wrong # of points ({{userPtsLen}} should be {{solnPtsLen}})': 'Falsche Anzahl von Punkten ({{userPtsLen}} sollte ${{solnPtsLen}} sein)',
        'You are missing {{missingCount}} shape(s)': 'Ihnen fehlen {{missingCount}} Form(en)',
        "You can't change the size of this group because {{shape}} can't be resized": 'Sie können die Größe dieser Gruppe nicht ändern, da die Größe von {{form}} nicht geändert werden kann',
        "You can't get or set the align property": 'Sie können die Align-Eigenschaft nicht abrufen oder festlegen',
        'You have {{extraCount}} extra shape(s)': 'Du hast {{extraCount}} zusätzliche Form(en)',
        'Your code appeared to be in an infinite loop, so it was terminated.': 'Your code appeared to be in an infinite loop, so it was terminated.',
        ...
        'addPoint': 'fügePunktHinzu',
        'add{{xy}}': 'addiere{{xy}}',
        'app.background should not be {{userBackgroundString}}': 'anwendung.hintergrund sollte nicht {{userBackgroundString}} sein',
        'app.setMaxShapeCount(n)': 'anwendung.setzeMaxFormAnzahl(n)',
        'at line': 'in Zeile',
        'black': 'schwarz',
        'bottom-left': 'unten-links',
        'bottom-right': 'unten-rechts',
        'center': 'mitte',
        'centroidX': 'mittelpunktX',
        'centroidY': 'mittelpunktY',
        'color': 'Farbe',
        'containsShape(targetShape)': 'beinhaltetForm(zielForm)',
        'gradient({{colors}}, start={{start}})': 'gradient({{colors}}, start={{start}})',
        'hits(x, y)': 'trifft(x,y)',
        'hitsShape(targetShape)': 'trifftForm(zielForm)',
        'initialPoints (x value)': 'anfangsPunkte (x wert)',
        'initialPoints (y value)': 'anfangsPunkte (y wert)',
        'integer': 'Integer',
        'keys must be a list': 'Schlüssel müssen eine Liste sein',
        'left-bottom': 'links-unten',
        'left-top': 'links-oben',
        'line': 'Linie',
        'list': 'Liste',
        'n': 'n',
        'non-negative-number': 'Nicht-negative Zahl',
        'number': 'Nummer',
        'number-greater-than-2': 'Zahl-größer-als-2',
        'number-in-range-{{lo}}-{{hi}}': 'Aufnahme startet in',
        'oval size': 'Größe Oval',
        'positive-number': 'Positive Zahl',
        'rgb({{r}}, {{g}}, {{b}})': 'RGB({{r}}, {{g}}, {{b}})',
        'right-bottom': 'rechts-unten',
        'right-top': 'rechts-oben',
        'rotate.cx': 'drehung.cx',
        'rotate.cy': 'drehung.cy',
        'rotate.degrees': 'drehung.winkel',
        'scale{{xy}}': 'skaliere{{xy}}',
        'shape': 'Form',
        'string': 'string',
        'targetShape': 'zielForm',
        'top-left': 'oben-links',
        'top-right': 'oben-rechts',
        'x': 'x',
        'y': 'y',
        '{{actual}} != {{expected}}': '{{aktuell}}! = {{erwartet}}',
        '{{attr}} in {{object}}': '{{attr}} in {{object}}',
        '{{attr}} should not be {{value}}': '{{attr}} sollte nicht {{value}} sein',
        '{{ordinalName}} point mismatch at {{location}}': '{{ordinalName}} Punkt stimmt nicht mit {{location}} überein',
        'play': 'abspielen',
        'pause': 'pausieren',
        'restart': 'neustarten',
        'loop': 'wiederholen',
        'TypeError': 'Typfehler',
        '{{error}}: in {{callSpec}}, {{value}} is not a legal align value': '{{error}}: in {{callSpec}}, {{value}} is not a legal align value',
        "{{error}}: {{callSpec}} got an unexpected keyword argument '{{arg}}'": "{{error}}: {{callSpec}} got an unexpected keyword argument '{{arg}}'",
        'contains(x, y)': 'beinhaltet(x, y)',
        'hitTest(x, y)': 'treffenTest(x, y)',
        'addPoint(x, y)': 'fügePunktHinzu(x, y)',
        'red': 'red',
        'green': 'green',
        'blue': 'blue',
        '{{callSpec}} must start with http:// or https://': '{{callSpec}} muss mit http:// or https:// beginnen',
    },
}
...
REVERSE_TRANSLATED_COLOR_NAMES = reverseTranslationDict(TRANSLATED_COLOR_NAMES)
REVERSE_TRANSLATED_GRADIENT_STARTS = reverseTranslationDict(TRANSLATED_GRADIENT_STARTS)
REVERSE_TRANSLATED_ALIGNS = reverseTranslationDict(TRANSLATED_ALIGNS)
REVERSE_TRANSLATED_SHAPE_ATTRS = reverseTranslationDict(TRANSLATED_SHAPE_ATTRS)
...
REVERSE_TRANSLATED_KEY_NAMES = reverseTranslationDict(TRANSLATED_KEY_NAMES)
REVERSE_TRANSLATED_APP_ATTRS = reverseTranslationDict(TRANSLATED_APP_ATTRS)
...
for language in TRANSLATED_USER_FUNCTION_NAMES:
    ...
    for en_name, trans_name in TRANSLATED_USER_FUNCTION_NAMES[language].items():
        TRANSLATED_USER_FUNCTION_NAMES[language][en_name] = accentCombinations(
            trans_name
        )
...
def typeError(obj, attr, value, typeName, isFn):
    if isFn:
        ...
        if isinstance(obj, str):
            ...
            callSpec = '{className}.{attr}'.format(
                className=t(obj.__class__.__name__), attr=t(attr)
            )
...
def checkInt(obj, attr, value, isFn):
    if not isinstance(value, int):
        typeError(obj, attr, value, t('integer'), isFn)
...
def checkPositive(obj, attr, value, isFn):
    ...
    if value <= 0:
        typeError(obj, attr, value, t('positive-number'), isFn)


def checkNonNegative(obj, attr, value, isFn):
    checkNumber(obj, attr, value, isFn)
    if value < 0:
        typeError(obj, attr, value, t('non-negative number'), isFn)
...
def checkRange(obj, attr, value, lo, hi, isFn):
    if (value < lo) or (value > hi):
        typeError(
            ...
            attr,
            value,
            t('number-in-range-{{lo}}-{{hi}}', {'lo': lo, 'hi': hi}),
            isFn,
        )


def checkValue(obj, attr, value, isFn):
    pass
...
def checkColor(obj, attr, value, isFn):
    if value is None or isinstance(value, RGB) or isinstance(value, Gradient):
        return
...
def checkBoolean(obj, attr, value, isFn):
    if not isinstance(value, bool):
        typeError(obj, attr, value, 'bool', isFn)


def checkArray(obj, attr, value, isFn):
    if not isinstance(value, list) and not isinstance(value, tuple):
        typeError(obj, attr, value, t('list'), isFn)
...
def checkBooleanOrArray(obj, attr, value, isFn):
    if not isinstance(value, list) and not isinstance(value, tuple):
        checkBoolean(obj, attr, value, isFn)


def checkAlign(obj, attr, value, isFn):
    if value is None:
        return  # None is a legal align
    if toEnglish(value, 'align') not in aligns:
        pyThrow(
            t(
                '{{error}}: in {{callSpec}}, {{value}} is not a legal align value',
                {
...
def checkNumPoints(obj, attr, value, isFn):
    checkInt(obj, attr, value, isFn)
    if value < 3:
        typeError(obj, attr, value, 'number-greater-than-2', isFn)


def checkRoundness(obj, attr, value, isFn):
    if value is None:
        return  # None is a legal roundness
...
def checkPoint(obj, attr, value, isFn):
    if not isinstance(value, list):
        typeError(obj, attr, value, 'list', isFn)
    if len(value) != 2:
        typeError(obj, attr, value, 'point (list of length 2)', isFn)
...
def toColorObject(v):
    if not v:
        return t('None')
    if isinstance(v, str):
        return CSS3_COLORS_TO_RGB[toEnglish(v, 'color').lower()] or v
    if isinstance(v, RGB) or isinstance(v, Gradient):
        return v
    raise Exception('toColorObject: unknown color type: {t}'.format(t=type(v)))


def RGBAlmostEqual(v1, v2, epsilon=2):
...
def reflectGradientStart(start):
    def toggle(s, a, b):
        if a in s and b in s:
            raise Exception('Illegal start format: {s}'.format(s=s))
...
def colorTest(v1, v2, epsilon):
    ...
    if type(v1) is not type(v2):
        return 0
    if isinstance(v1, RGB):
        return 1 if RGBAlmostEqual(v1, v2, epsilon) else 0
    if isinstance(v1, Gradient):
        start1 = canonicalizeGradientStart(v1.start)
        start2 = canonicalizeGradientStart(v2.start)
        if start1 != start2 and start1 != reflectGradientStart(start2):
            return 0
...
def eqTest(v1, v2):
    if (
        ...
        or isinstance(v2, int)
        or isinstance(v2, float)
    ):
        return 1 if abs(v1 - v2) < 0.005 else 0
    if (isinstance(v1, list) or isinstance(v1, tuple)) and (
        isinstance(v2, list) or isinstance(v2, tuple)
    ):
        if len(v1) != len(v2):
            return 0
        for i in range(len(v1)):
            if eqTest(v1[i], v2[i]) == 0:
                return 0
        return 1
    return 1 if v1 == v2 else 0


def opacityTest(v1, v2):
    return eqTest(v1, v2)
...
class RGB(object, metaclass=_ShapeMetaclass):
    ...
    def __setattr__(self, attr, value):
        if attr[0] == '_':
            ...
            raise Exception(
                t(
                    "Cannot modify attribute '{{attr}}' of '{{className}}' object",
                    {'attr': attr, 'className': t('rgb')},
                )
            )

    def darker(self):
        k = 0.85
        return RGB(round(k * self.red), round(k * self.green), round(k * self.blue))
...
def canonicalizeGradientStart(start):
    ...
    if start in alternateGradientStarts:
        return alternateGradientStarts[start]
    return start
...
class Gradient(object, metaclass=_ShapeMetaclass):
    def __init__(self, colors, start):
        ...
        if len(colors) < 2:
            pyThrow(
                t(
                    'Need to pass at least 2 colors to gradient(); you gave {{colorLen}}',
                    {'colorLen': len(colors)},
                )
            )
        for color in colors:
    ...
    def __eq__(self, other):
        ...
        if len(self.colors) != len(other.colors):
            return False
        if canonicalizeGradientStart(self.start) != canonicalizeGradientStart(
            other.start
        ):
            return False
...
class Drawing(object):
    def __init__(self):
        ...
        self.images = {}
        self.addCounter = 0
        self.appProperties = {'maxShapeCount': 2000}
        self.nextShapeId = 0
...
class Shape(object):
    def __init__(self, attrs=None):
        ...
        if attrs is not None:
            self.set(attrs)
        if (not attrs or not attrs.get('noGroup', False)) and (
    ...
    def set_group(self, v):
        pyThrow(t("You can't set the group property"))

    group = shape_property(get_group, set_group)

    def get_align(self):
        pyThrow(t("You can't get or set the align property"))
    ...
    def get_doNotInspect(self):
        return self.attrs.get('doNotInspect', None)

    def set_doNotInspect(self, v):
        self.attrs['doNotInspect'] = v
        return v

    doNotInspect = shape_property(get_doNotInspect, set_doNotInspect)

    def get_centerX(self):
        return self.get('centerX', None)
    ...
    def set_fill(self, v):
        return self.set({'fill': v})

    fill = shape_property(get_fill, set_fill)

    def get_border(self):
        return self.get('border')

    def set_border(self, v):
        return self.set({'border': v})

    border = shape_property(get_border, set_border)

    def get_borderWidth(self):
        return self.get('borderWidth')

    def set_borderWidth(self, v):
        return self.set({'borderWidth': v})

    borderWidth = shape_property(get_borderWidth, set_borderWidth)

    def get_dashes(self):
        return self.get('dashes')

    def set_dashes(self, v):
        return self.set({'dashes': v})
    ...
    def set_db(self, v):
        return self.set({'db': v})

    db = shape_property(get_db, set_db)

    def get_visible(self):
        return (self._group is not None) and (
            self._group.visible or self._group == activeDrawing.tlg._shape
        )
    ...
    def set_centroid(self, v):
        pyThrow('Centroid cannot be set')
    ...
    def get_rotateAngle(self):
        return self.get('rotateAngle')

    def set_rotateAngle(self, v):
        self._rotate(v - self.rotateAngle)
    ...
    def _toString(self):
        return self.toString()  # so cmu_graphics can access toString

    def contains(self, *arguments):  # contains(x,y)
        checkArgCount(
            self.__class__.__name__, t('contains'), [t('x'), t('y')], arguments
        )
        x, y = arguments
    ...
    def _hits(self, x, y):
        ...
        if not utils.polygonContainsPoint(pts, x, y):
            return False
        if self._filled():
            return True
        border = self.border
    ...
    def boundsIntersect(self, targetShape, margin=None):
        ...
        return (
            (b1['left'] + margin <= b2['left'] + b2['width'])
            and (b2['left'] + margin <= b1['left'] + b1['width'])
            and (b1['top'] + margin <= b2['top'] + b2['height'])
            and (b2['top'] + margin <= b1['top'] + b1['height'])
        )

    def hitsShape(self, *arguments):
        checkArgCount(
            self.__class__.__name__, t('hitsShape'), [t('targetShape')], arguments
        )
        (targetShape,) = arguments
...
class Group(Shape):
    ...
    def add(self, *shapes):
        for i in range(len(shapes)):
            ...
            if activeDrawing.addCounter % 100 == 0:
                if (
                    countShapesInGroup(activeDrawing.tlg)
                    > activeDrawing.appProperties['maxShapeCount']
                ):
                    pyThrow(
                        t(
                            'Too many shapes: Your code created more than {{maxShapeCount}} shapes. If you would like to increase this limit even though it may cause your code to run slowly, call app.setMaxShapeCount(n).',
    ...
    def scalexy(self, varName, k, scaleAnchor=None):
        ...
        for s in self._shapes:
            s.scalexy(varName, k, scaleAnchor)
    ...
    def getPTA(self, attr):
        ...
        for shape in self._shapes:
            if val is None:
                ...
                if (
                    attr == 'fill' and not colorTest(getattr(shape, attr), val, 0.005)
    ...
    def get_fill(self):
        return self.getPTA('fill')

    def set_fill(self, v):
        return self.setPTA('fill', v)

    fill = shape_property(get_fill, set_fill)

    def get_opacity(self):
        return self.getPTA('opacity')

    def set_opacity(self, v):
        return self.setPTA('opacity', v)
    ...
    def get_border(self):
        return self.noPTA('border')

    def set_border(self, v):
        return self.noPTA('border', v)

    border = shape_property(get_border, set_border)

    def get_borderWidth(self):
        return self.noPTA('borderWidth')

    def set_borderWidth(self, v):
        return self.noPTA('borderWidth', v)

    borderWidth = shape_property(get_borderWidth, set_borderWidth)

    def get_dashes(self):
        return self.noPTA('dashes')

    def set_dashes(self, v):
        return self.noPTA('dashes', v)

    dashes = shape_property(get_dashes, set_dashes)

    def get_arrowEnd(self):
        return self.noPTA('arrowEnd')

    def set_arrowEnd(self, v):
        return self.noPTA('arrowEnd', v)

    arrowEnd = shape_property(get_arrowEnd, set_arrowEnd)

    def get_arrowStart(self):
        return self.noPTA('arrowStart')

    def set_arrowStart(self, v):
        return self.noPTA('arrowStart', v)

    arrowStart = shape_property(get_arrowStart, set_arrowStart)

    def get_url(self):
        return self.noPTA('url')

    def set_url(self, v):
        return self.noPTA('url', v)

    url = shape_property(get_url, set_url)

    def get_radius(self):
        return self.noPTA('radius')

    def set_radius(self, v):
        return self.noPTA('radius', v)

    radius = shape_property(get_radius, set_radius)

    def get_points(self):
        return self.noPTA('points')

    def set_points(self, v):
        return self.noPTA('points', v)

    points = shape_property(get_points, set_points)

    def get_roundness(self):
        return self.noPTA('roundness')

    def set_roundness(self, v):
        return self.noPTA('roundness', v)

    roundness = shape_property(get_roundness, set_roundness)

    def get_x1(self):
        return self.noPTA('x1')

    def set_x1(self, v):
        return self.noPTA('x1', v)

    x1 = shape_property(get_x1, set_x1)

    def get_y1(self):
        return self.noPTA('y1')

    def set_y1(self, v):
        return self.noPTA('y1', v)

    y1 = shape_property(get_y1, set_y1)

    def get_x2(self):
        return self.noPTA('x2')

    def set_x2(self, v):
        return self.noPTA('x2', v)

    x2 = shape_property(get_x2, set_x2)

    def get_y2(self):
        return self.noPTA('y2')

    def set_y2(self, v):
        return self.noPTA('y2', v)

    y2 = shape_property(get_y2, set_y2)

    def get_lineWidth(self):
        return self.noPTA('lineWidth')

    def set_lineWidth(self, v):
        return self.noPTA('lineWidth', v)

    lineWidth = shape_property(get_lineWidth, set_lineWidth)

    def get_closed(self):
        return self.noPTA('closed')

    def set_closed(self, v):
        return self.noPTA('closed', v)

    closed = shape_property(get_closed, set_closed)

    def get_startAngle(self):
        return self.noPTA('startAngle')

    def set_startAngle(self, v):
        return self.noPTA('startAngle', v)

    startAngle = shape_property(get_startAngle, set_startAngle)

    def get_sweepAngle(self):
        return self.noPTA('sweepAngle')

    def set_sweepAngle(self, v):
        return self.noPTA('sweepAngle', v)

    sweepAngle = shape_property(get_sweepAngle, set_sweepAngle)

    def get_value(self):
        return self.noPTA('value')

    def set_value(self, v):
        return self.noPTA('value', v)

    value = shape_property(get_value, set_value)

    def get_font(self):
        return self.noPTA('font')

    def set_font(self, v):
        return self.noPTA('font', v)

    font = shape_property(get_font, set_font)

    def get_size(self):
        return self.noPTA('size')

    def set_size(self, v):
        return self.noPTA('size', v)

    size = shape_property(get_size, set_size)

    def get_bold(self):
        return self.noPTA('bold')

    def set_bold(self, v):
        return self.noPTA('bold', v)

    bold = shape_property(get_bold, set_bold)

    def get_italic(self):
        return self.noPTA('italic')

    def set_italic(self, v):
        return self.noPTA('italic', v)
...
class Label(Shape):
    ...
    def setDims(self):
        ...
        hasOuterSpaces = len(stringValue) > 0 and (
            stringValue[0] == ' ' or stringValue[-1] == ' '
        )
        if hasOuterSpaces:
        ...
        a = self.rotateAngle
        if a:
            pts = utils.rotatePoints(pts, a, self.centerX, self.centerY)
    ...
    def set_width(self, v):
        pyThrow(t("Cannot set Label's width"))
    ...
    def set_height(self, v):
        pyThrow(t("Cannot set Label's height"))
...
class Polygon(Shape):
    def __init__(self, attrs=None):
        if attrs is not None and 'initialPoints' in attrs:
            if len(attrs['initialPoints']) % 2 != 0:
                pyThrow(
                    t('Must have an even number of x,y values in initialPoints list')
                )
    ...
    def get_left(self):
        return utils.min_or_inf(list(map(lambda point: point[0], self.pointList)))
    ...
    def get_top(self):
        return utils.min_or_inf(list(map(lambda point: point[1], self.pointList)))
    ...
    def get_right(self):
        return max(map(lambda point: point[0], self.pointList))
    ...
    def get_bottom(self):
        return max(map(lambda point: point[1], self.pointList))
...
class Line(Polygon):
    def __init__(self, attrs):
        attrs['initialPoints'] = utils.flatten(
            utils.getLinePoints(attrs['x1'], attrs['y1'], attrs['x2'], attrs['y2'], 2)
        )
    ...
    def get_x1(self):
        return self.getXY(0, 3, 0, 'x1')  # x1,y1 at points 0 and 3, 0=x

    def set_x1(self, v):
        return self.setXY(0, 3, 0, v, 'x1')  # x1,y1 at points 0 and 3, 0=x

    x1 = shape_property(get_x1, set_x1)

    def get_y1(self):
        return self.getXY(0, 3, 1, 'y1')  # x1,y1 at points 0 and 3, 1=y

    def set_y1(self, v):
        return self.setXY(0, 3, 1, v, 'y1')  # x1,y1 at points 0 and 3, 1=y

    y1 = shape_property(get_y1, set_y1)

    def get_x2(self):
        return self.getXY(1, 2, 0, 'x2')  # x2,y2 at points 1 and 2, 0=x

    def set_x2(self, v):
        return self.setXY(1, 2, 0, v, 'x2')  # x2,y2 at points 1 and 2, 0=x

    x2 = shape_property(get_x2, set_x2)

    def get_y2(self):
        return self.getXY(1, 2, 1, 'y2')  # x2,y2 at points 1 and 2, 1=y

    def set_y2(self, v):
        return self.setXY(1, 2, 1, v, 'y2')  # x2,y2 at points 1 and 2, 1=y

    y2 = shape_property(get_y2, set_y2)

    def get_arrowStart(self):
        return self.get('arrowStart')

    def set_arrowStart(self, v):
        return self.set({'arrowStart': v})

    arrowStart = shape_property(get_arrowStart, set_arrowStart)

    def get_arrowEnd(self):
        return self.get('arrowEnd')

    def set_arrowEnd(self, v):
        return self.set({'arrowEnd': v})
    ...
    def set_borderWidth(self, v):
        pyThrow(t("Cannot set Line's borderWidth"))
    ...
    def set_border(self, v):
        pyThrow(t("Cannot set Line's border"))

    border = shape_property(get_border, set_border)

    def get_area(self):
        return self.lineWidth * utils.distance(self.x1, self.y1, self.x2, self.y2)
...
class PolygonInCircle(Polygon):
    ...
    def get_centerX(self):
        return utils.round2(self.centroid[0])
    ...
    def get_centerY(self):
        return utils.round2(self.centroid[1])
...
class RegularPolygon(PolygonInCircle):
    def __init__(self, attrs):
        attrs['initialPoints'] = utils.flatten(
            utils.getRegularPolygonPoints(
                attrs['centerX'], attrs['centerY'], attrs['radius'], attrs['points'], 0
            )
        )
        super().__init__(attrs)

    def updatePointList(self):
        self.pointList = utils.getRegularPolygonPoints(
            self.centerX, self.centerY, self.radius, self.points, self.rotateAngle
        )
...
class Star(PolygonInCircle):
    ...
    def updatePointList(self):
        self.pointList = utils.getStarPoints(
            self.centerX,
            self.centerY,
            self.radius,
            self.points,
...
class PolygonWithTransform(Polygon):
    def get_transformMatrix(self):
        return self.get('transformMatrix')

    def set_transformMatrix(self, v):
        return self.set({'transformMatrix': v})
...
class CMUImage(PolygonWithTransform):
    ...
    def set_url(self, v):
        pyThrow(t("Cannot set Image's url"))
...
class Oval(PolygonWithTransform):
    def __init__(self, attrs):
        attrs['initialPoints'] = utils.flatten(
            utils.getArcPoints(
                ...
                attrs['width'],
                attrs['height'],
                attrs.get('startAngle', None),
                attrs.get('sweepAngle', None),
                None,
                attrs['isMvc'],
            )
        )
        ...
        attrs['bezierPoints'] = Oval.getBezierPoints(
            attrs['startAngle'], attrs['sweepAngle'], attrs['isMvc']
        )
        super().__init__(attrs)
    ...
    def getBezierPoints(startAngle, sweepAngle, isMvc):
        ...
        while remaining > 0:
            bp.extend(
                Oval.getBezierFragment(
                    utils.toRadians(min(90, remaining)), offset, isMvc
                )
            )
            offset += math.pi / 2
            remaining -= 90
    ...
    def getBezierFragment(sweepAngle, offsetAngle, isMvc):
        ...
        result = utils.rotatePoints(result, utils.toDegrees(angle), 0, 0)

        if isMvc:
            result = [[pair[0], -pair[1]] for pair in result]
        return result

    def get_bezierPoints(self):
        return self.get('bezierPoints')

    def set_bezierPoints(self, v):
        return self.set({'bezierPoints': v})
...
class Arc(Oval):
    ...
    def get_ovalWidth(self):
        return self.get('ovalWidth')

    def set_ovalWidth(self, v):
        return self.set({'ovalWidth': v})

    ovalWidth = shape_property(get_ovalWidth, set_ovalWidth)

    def get_ovalHeight(self):
        return self.get('ovalHeight')

    def set_ovalHeight(self, v):
        return self.set({'ovalHeight': v})
    ...
    def regeneratePoints(self):
        ...
        self.bezierPoints = Oval.getBezierPoints(
            self.startAngle, self.sweepAngle, self.isMvc
        )
    ...
    def get_centerX(self):
        return utils.round2(self.pointList[0][0])
    ...
    def get_centerY(self):
        return utils.round2(self.pointList[0][1])
...
class Circle(Oval):
    ...
    def get_radius(self):
        if self._exactRadius is not None:
    ...
    def get__exactRadius(self):
        return self.get('_exactRadius')

    def set__exactRadius(self, v):
        return self.set({'_exactRadius': v})
...
class Inspector(object):
    ...
    def getKeyPoints(self, shape):
        ...
        if isinstance(shape, Arc):
            ...
            (
                shape.rotateAngle % 360 != 0
                and (isinstance(shape, Oval) or isinstance(shape, Rect))
            )
            or isinstance(shape, Circle)
            or isinstance(shape, Oval)
            or isinstance(shape, Star)
            or isinstance(shape, RegularPolygon)
            or isinstance(shape, Label)
        ):
    ...
    def ensureKeyPointToShapesMap(self):
        if self.keyPointsToShapes is not None:
            return
        ...
        for shape in self.keyPointsToShapes[key]:
            ...
            def checkAttrDefaults(attrDefaults):
                for attr, defaultVal in attrDefaults:
                    try:
                        val = getattr(shape, attr)
                        if val is not None and val != defaultVal:
                            msgsAdd(attr, val)
                    except Exception:
                        pass
            ...
            if isinstance(shape, Arc):
                ...
                if shape.ovalWidth is not None and shape.ovalHeight is not None:
                    msgsAdd(
                        t('oval size'),
                        '(%d, %d)'
                        % (
            ...
            if (
                isinstance(shape, Oval)
                and not isinstance(shape, Circle)
                and not isinstance(shape, Arc)
            ) or (shape.rotateAngle % 360 != 0 and isinstance(shape, Rect)):
                pts = shape.getApproxPoints()
                unrotatedPoints = utils.rotatePoints(
                    pts, -shape.rotateAngle, shape.centerX, shape.centerY
                )
                bounds = utils.getBoxDims(unrotatedPoints)
                msgsAdd(
                    t('size'),
                    '(%d, %d)'
                    % (utils.round2(bounds['width']), utils.round2(bounds['height'])),
                )
    ...
    def computeBestPoint(self):
        ...
        if (
            bestX is None
            or utils.distance(self.mouseX, self.mouseY, bestX, bestY) > 300
        ):
            self.bestX = self.bestY = None
        else:
            self.bestX = bestX
    ...
    def draw(self, ctx):
        ...
        pointLabelCenterX = min(
            self.app.width - margin - w / 2, max(margin + w / 2, self.bestX - 10)
        )
...
class ShapeLogicInterface(object):
    ...
    def slGet(self, slObj, attr):
        ...
        if callable(result):
            ...
            def result(*args, **kwargs):
                return self.slApply(slObj, attr, args, kwargs)
    ...
    def slSetWithTypeCheck(self, obj, attr, val):
        ...
        if shapeAttrs.get(attr, None) is not None:
            ...
            pyThrow(
                t(
                    "{{methodName}} is a function. You can't assign to it.",
                    {
            ...
            utils.internalError(f'No type check function found for {className}.{attr}')
        return val
    ...
    def slInitShape(self, clsName, argNames, args, kwargs, isMvc):
        ...
        try:
            ...
            if align is not None:
                ...
                xPoint = (
                    constructorArgs.get('left', None)
                    if constructorArgs.get('centerX', None) is None
                    else constructorArgs['centerX']
                )
                yPoint = (
                    constructorArgs.get('top', None)
                    if constructorArgs.get('centerY', None) is None
                    else constructorArgs['centerY']
                )
