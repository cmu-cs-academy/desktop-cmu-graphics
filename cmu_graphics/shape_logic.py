...
class Shape(object):
    ...
    def get_visible(self):
        return (self.group != None) and (self.group.visible or self.group == activeDrawing.tlg._shape)
