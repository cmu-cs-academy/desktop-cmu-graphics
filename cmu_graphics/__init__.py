...
try:
    ...
    main_directory = os.path.dirname(os.path.abspath(__main__.__name__))
    print(f"""Attention:
You are running cmu_graphics from a REPL, and your working directory is {main_directory}.
Be mindful of how you reference and specify paths of any external file.""")
