...
p = Polygon(50, 50, 350, 100, 300, 200, 100, 350)
...
assertRaises(test_x0_error, "cannot access 'x0' because point numbers start from 1")
...
assertRaises(test_y0_error, "cannot access 'y0' because point numbers start from 1")
...
assertRaises(test_y5_error, "cannot access 'y5' because it only has 4 points")
...
assertRaises(test_x5_error, "cannot access 'x5' because it only has 1 point")
...
hexagon = Polygon(200, 100, 300, 150, 300, 250, 200, 300, 100, 250, 100, 150)
...
rect = Polygon(50, 50, 250, 50, 250, 150, 50, 150)
rect.x1 = 30
rect.y1 = 30
rect.x2 = 270
rect.y2 = 70
